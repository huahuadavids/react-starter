...
const generateCategoricalChart = ({
  ...
  class CategoricalChartWrapper extends Component {
    ...
    /**
     * Returns default, reset state for the categorical chart-d3.
   ...
   */
     ...
     * this kind of axis does not display in chart-d3
     * @param  {Object} props         Latest props
     * @param  {Array} graphicalItems The instances of item
    ...
    /**
     * Get the information of mouse in chart-d3, return null when the mouse is not in the chart-d3
    ...
    handleReceiveSyncEvent = (cId, chartId, data) => {
      ...
      if (syncId === cId && chartId !== this.uniqueChartId) {
        ...
        if (!_.isNil(data.dataStartIndex) || !_.isNil(data.dataEndIndex)) {
          ...
          // When a categotical chart-d3 is combined with another chart-d3, the value of chartX
    ...
    /**
     * The handler of mouse entering chart-d3
    ...
    /**
     * The handler of mouse moving in chart-d3
     * @param  {Object} e        Event object
    ...
    /**
     * The handler if mouse leaving chart-d3
     * @param {Object} e Event object
     * @return {Null} no return
     */
    handleMouseLeave = (e) => {
